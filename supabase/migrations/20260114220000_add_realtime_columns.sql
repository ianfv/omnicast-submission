...
-- Note: The hosts JSONB structure update (adding elevenlabs_voice_id) is handled at the application 
-- level in TypeScript types. We don't enforce JSONB structure at the database level to maintain
